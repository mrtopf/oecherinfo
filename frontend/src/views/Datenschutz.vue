<template>
    <v-container>
        <h1 class="text-h3 font-weight-bold">Datenschutzerklärung</h1>
        ...
        <h3>Verantwortlich für die Datenerfassung</h3>
        <p>
        ...
        <p>
            <b>COM.lounge GmbH</b><br />
            Hanbrucher Str. 33<br />
            52064 Aachen<br />
        </p>

        <p>
            Telefon: 0241/4007300<br />
            E-Mail: info@comlounge.net
        </p>
        <p>
        ...
        <!-- <h3>Widerruf Ihrer Einwilligung zur Datenverarbeitung<h3></h3>
<p>
Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.
        ...
        <ul>
            <li>
                Wir speichern Logfiles für 14 Tage, um Angriff abwehren zu
        ...
        <p>
            Die Nutzung von Matomo erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
            f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der
            anonymisierten Analyse des Nutzerverhaltens, um sein Webangebot zu
            optimieren.
        </p>
        <p>
